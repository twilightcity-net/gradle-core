 ...
 */
package org.dreamscale.gradle.resource

import org.dreamscale.gradle.test.TestFile
import org.dreamscale.gradle.test.AbstractPluginSupportSpecification

class ProjectRootUrlResolverSpecification extends AbstractPluginSupportSpecification {
	...
	def "getResourceAsUrlOrNull should return URL if resource accessible from project root"() {
		given:
		TestFile resourceFile = projectFS.file("somedir/resource.txt") << "content"
