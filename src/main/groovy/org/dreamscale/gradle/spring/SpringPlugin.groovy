 ...
 */
package org.dreamscale.gradle.spring

import org.dreamscale.gradle.ide.IdeExtPlugin
import org.dreamscale.gradle.ide.IdeaExtExtension
...
class SpringPlugin implements Plugin<Project> {
    ...
    private void addLocalSpringProfileToTasksAndIdeaApplicationConfigurations() {
        IdeaExtExtension ideaExtension = IdeaExtExtension.getInstance(project)
